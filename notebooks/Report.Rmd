...
Since we obtained 15 models as a result of the training, we have decided to choose 6 in order to comment on the most interesting results. In choosing these models, we have relied on the models with the best accuracy, recall, F1-Score and AUC; resulting in:

- **Best accuracy**: `rf_filtered` and `rf_weighted`
...
In the section [supervised analysis](#supervised-analysis-2) we will analyse the results provided by the rf_onehot, rf_filtered, rf_weigthed, gbm_filtered, gbm_pca and gbm_smote models.

## Analysis II

*Results: tables and/or figures presenting the obtained results* (1.5 points)

### Supervised Analysis {#supervised-analysis-2}
## Discussion
