...
apply_algorithm <- function(algorithm, tuneGrid, train_data, test_data, model_path, predictions_path, use_weights = FALSE) {
  ...
  # Load the model (train_data will not be used)
  load(model_path)
  
  # Características esperadas por el modelo
  expected_features <- model$feature_names
  
  # Características en el conjunto de prueba
  test_features <- colnames(test_data)
  
  # Comparar columnas faltantes en test_data
  missing_features <- setdiff(expected_features, test_features)
  cat("Columnas faltantes en test_data:\n")
  print(missing_features)
  
  # Comparar columnas adicionales en test_data
  extra_features <- setdiff(test_features, expected_features)
  cat("Columnas adicionales en test_data:\n")
...
```{r}
process_damage_grade <- function(input_file, output_file) {
  data <- read.csv(input_file)
  
  new_data <- data %>%
    mutate(
      building_id = seq(0, nrow(data) - 1),
      damage_grade = as.numeric(sub("X", "", damage_grade_pred))
    ) %>%
    select(building_id, damage_grade)
  
  write.csv(new_data, output_file, row.names = FALSE)
  
  message("Submission file created:", output_file)
}

process_damage_grade("../data/predictions/rf_onehot_predictions.csv", "../results/rf_onehot_submission.csv")
process_damage_grade("../data/predictions/rf_filtered_onehot_predictions.csv", "../results/rf_filtered_onehot_submission.csv")
process_damage_grade("../data/predictions/rf_pca_predictions.csv", "../results/rf_pca_submission.csv")
process_damage_grade("../data/predictions/rf_smote_predictions.csv", "../results/rf_smote_submission.csv")
process_damage_grade("../data/predictions/rf_weighted_predictions.csv", "../results/rf_weighted_submission.csv")

process_damage_grade("../data/predictions/gbm_onehot_predictions.csv", "../results/gbm_onehot_submission.csv")
process_damage_grade("../data/predictions/gbm_filtered_onehot_predictions.csv", "../results/gbm_filtered_onehot_submission.csv")
process_damage_grade("../data/predictions/gbm_pca_predictions.csv", "../results/gbm_pca_submission.csv")
process_damage_grade("../data/predictions/gbm_smote_predictions.csv", "../results/gbm_smote_submission.csv")
process_damage_grade("../data/predictions/gbm_weighted_predictions.csv", "../results/gbm_weighted_submission.csv")

process_damage_grade("../data/predictions/sgb_onehot_predictions.csv", "../results/sgb_onehot_submission.csv")
process_damage_grade("../data/predictions/sgb_filtered_onehot_predictions.csv", "../results/sgb_filtered_onehot_submission.csv")
process_damage_grade("../data/predictions/sgb_pca_predictions.csv", "../results/sgb_pca_submission.csv")
process_damage_grade("../data/predictions/sgb_smote_predictions.csv", "../results/sgb_smote_submission.csv")
process_damage_grade("../data/predictions/sgb_weighted_predictions.csv", "../results/sgb_weighted_submission.csv")
```
