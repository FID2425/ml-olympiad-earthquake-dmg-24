...
```{r}
write.csv(reduced_data, "../data/processed/pre_onehot_train.csv", row.names = FALSE)
```
...
```{r}
write.csv(df_one_hot, "../data/processed/onehot_train.csv", row.names = FALSE)
```
...
```{r}
write.csv(df_correlation, "../data/processed/filtered_onehot_train.csv", row.names = FALSE)
```
...
```{r}
write.csv(pca_data, "../data/processed/pca_train.csv", row.names = FALSE)
```
...
```{r}
write.csv(smoted_df, "../data/processed/smote_train.csv", row.names = FALSE)
```
...
```{r}
write.csv(processed_data, "../data/processed/weighted_train.csv", row.names = FALSE)
```
