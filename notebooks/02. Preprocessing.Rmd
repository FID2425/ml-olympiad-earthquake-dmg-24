...
```{r}
# Load the data
test_data <- read.csv("../data/raw/raw_data_test.csv")

## Remove the has_secondary_use column
new_df <- test_data %>% select(-has_secondary_use)
...
```{r}
# Remove the target variable
data_without_target_test <- processed_data_test
...
# Add the target variable back to the dataset
pca_data_test <- pca_components_test
```
