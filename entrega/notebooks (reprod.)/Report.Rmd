...
relatively clean, with no missing values in the columns as shown in Figure 1.

<div>

<center>![](../docs/images/datadist.png)</center>

</div>

<div>

<center><b>Figure 1:</b> Data distribution.</center>
...
<center>![](../docs/images/boxplot.png)</center>

</div>

<div>

<center><b>Figure 2:</b> Height and Area percentage data distribution</center>
...
two at most (Figure 5), rarely more that that. We also found that most
buildings were registered as being 0 years since construction, and there 
was also a spike at 30 years since construction, which could mean that wither
there was a boom in construction 30 years ago, or that the data was not
properly recorded.

<div>

<center>![](../docs/images/agehist.png)</center>

</div>

<div>

<center><b>Figure 3:</b> Building age histogram</center>
...
<center>![](../docs/images/floorshist.png)</center>

</div>

<div>

<center><b>Figure 4:</b> Building floors histogram</center>
...
<center>![](../docs/images/familycounthist.png)</center>

</div>

<div>

<center><b>Figure 5:</b> Building family count histogram</center>
...
features we tried to extract any relation or meaning behind
...
<center>![](../docs/images/secondusehist.png)</center>

</div>

<div>

<center><b>Figure 6:</b> Buildings secondary use data distribution</center>
...
<center>![](../docs/images/datacorr.png)</center>

</div>

<div>

<center><b>Figure 7:</b> Data correlation</center>
...
libraries for clustering, the `keras` library for the autoencoder and the `Rtsne` library for the t-SNE. We have also used the `factoextra`, `mass`
and `plotly` libraries for the visualization.

#### In-depth analysis

We first applied the `k-means` and `hierarchical` clustering algorithms
with the `numeric` dataset. Having no clear conclusions or patterns
identified after the clustering, we decided follow up with dimensionality
...
Lastly, we ran `db-scan` clustering algorithm with the `autoencoder`
...
The results of the unsupervised analysis are presented in section
[unsupervised analysis II]{#unsupervised-analysis-2}.
...
<center><b>Figure 8:</b> AUC-ROC Curve for the `gbm_smote`
model.</center>

</div>

As shown in Figure 8, while the AUC is relatively close to 0.5, it
...
### Unsupervised Analysis Results {#unsupervised-analysis-2}
...
<center><b>Figure 9:</b> Elbow method for K-Means clustering</center>
...
<center><b>Figure 10:</b> Silhouette method for K-Means
clustering</center>
...
<center><b>Figure 11:</b> Parallel coordinates plot for K-Means
clusters</center>
...
<center><b>Figure 12:</b> Dendogram for `complete` hierarchical
...
<center><b>Figure 13:</b> Autoencoder performance during
training</center>
...
<center><b>Figure 14:</b> Encoded data plotted in 3D</center>
...
<center><b>Figure 15:</b> Tsne data plotted in 3D</center>
...
<center><b>Figure 16:</b> Clusters for the PCA dataset (first 3
dimensions)</center>
...
<center><b>Figure 17:</b> t-Sne clusters obtained with K-Means</center>
...
<center><b>Figure 18:</b> t-Sne clusters obtained with DB-Scan</center>
